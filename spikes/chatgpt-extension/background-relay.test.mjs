...
const chrome = {
  ...
  tabs: {
    async sendMessage(tabId, message) {
      ...
      if (message.type === 'adapterStatusV3') return { ok: true, adapterVersion: '1.3.2' };
      if (message.type === 'sendMiddlewareMessageV3') return { ok: true, response: 'relay reply', adapterVersion: '1.3.2' };
...
assert.deepEqual(JSON.parse(JSON.stringify(socketSent.at(-1))), {
  ...
  protocolJsonPresent: false, adapterVersion: '1.3.2', relay: true,
