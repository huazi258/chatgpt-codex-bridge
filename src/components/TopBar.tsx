  ...
  return <header className="topbar">
    ...
    <div className="channel-cluster">
      <div className="channel-status-wrap">
        <button className={`channel-status ${pairing?.paired ? 'healthy' : 'offline'}`} type="button" onClick={() => setDetails(details === 'chatgpt' ? null : 'chatgpt')} title="查看 ChatGPT 通道详情">● ChatGPT</button>
