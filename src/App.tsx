...
export default function App() {
  ...
  async function retryUnknownMessage(message: RelayMessage) {
    setBusy(true);
    try {
      await invoke('retry_unknown_relay_message', { messageId: message.id });
